...
async def async_setup_entry(
    ...
    """Initialize Learning Sensor from a config entry."""
    _LOGGER.debug(
        "Setting up config entry for Bayesian sensor: '%s' with %s observations",
...
class LearningBinarySensor(BinarySensorEntity):
    """Representation of a learning sensor."""
    ...
    def __init__(
        ...
        self._attr_unique_id = unique_id and f"learning-sensor-{unique_id}"
